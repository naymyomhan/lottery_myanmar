...
class MmMorningNumber extends Resource
{   

    /**
     * The model the resource corresponds to.
     *
     * @var class-string<\App\Models\MmMorningNumber>
     */
    public static $model = \App\Models\MmMorningNumber::class;
    ...
    public function fields(NovaRequest $request)
    {
        return [
            ...
            // AuditableLog::make(),
             HasMany::make('Bets','mm_morning_bets',MmMorningBet::class),
        ];
    }
