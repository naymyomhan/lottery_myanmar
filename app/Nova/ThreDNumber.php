...
class ThreDNumber extends Resource
{
    /**
     * The model the resource corresponds to.
     *
     * @var class-string<\App\Models\ThreDNumber>
     */
    public static $model = \App\Models\ThreDNumber::class;
    ...
    public function fields(NovaRequest $request)
    {
        return [
            ...
            BelongsTo::make('Date','ledger',Ledger::class)->withMeta(['extraAttributes' => ['readonly' => true]])->hideWhenUpdating(),
