...
class MmAfterNoonNumber extends Resource
{
    /**
     * The model the resource corresponds to.
     *
     * @var class-string<\App\Models\MmAfterNoonNumber>
     */
    public static $model = \App\Models\MmAfterNoonNumber::class;
    ...
    public function fields(NovaRequest $request)
    {
        return [
            ...
            // AuditableLog::make(),
             HasMany::make('Bets','mm_after_noon_bets',MmAfterNoonBet::class),
        ];
    }
