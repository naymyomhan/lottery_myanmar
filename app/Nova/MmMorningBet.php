...
class MmMorningBet extends Resource
{
    public static $perPageViaRelationship = 20;
    /**
     * The model the resource corresponds to.
     *
     * @var class-string<\App\Models\MmMorningBet>
     */
    public static $model = \App\Models\MmMorningBet::class;
    ...
    {
        return [
            BelongsTo::make('Number','mm_morning_number',MmMorningNumber::class),
