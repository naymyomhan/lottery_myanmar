...
class MmNoonNumber extends Resource
{
    /**
     * The model the resource corresponds to.
     *
     * @var class-string<\App\Models\MmNoonNumber>
     */
    public static $model = \App\Models\MmNoonNumber::class;
    ...
    public function fields(NovaRequest $request)
    {
        return [
            ...
            // AuditableLog::make(),
             HasMany::make('Bets','mm_noon_bets',MmNoonBet::class),
        ];
    }
