...
class MmNoonBet extends Resource
{
     ...
     *
     * @var class-string<\App\Models\MmNoonBet>
     */
    public static $model = \App\Models\MmNoonBet::class;
    ...
    {
        return [
            BelongsTo::make('Number','mm_noon_number',MmNoonNumber::class),
