...
class MmEveningBet extends Resource
{
    public static $perPageViaRelationship = 20;
    /**
     * The model the resource corresponds to.
     *
     * @var class-string<\App\Models\MmEveningBet>
     */
    public static $model = \App\Models\MmEveningBet::class;
    ...
    {
        return [
            BelongsTo::make('Number','mm_evening_number',MmEveningNumber::class)->sortable(),  
